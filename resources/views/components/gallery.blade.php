        ...
        <div class="">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="container_main">
                            <img src="{{ asset('assets/images/img-1.png') }}" alt="Avatar" class="image">
                            <div class="overlay">
            ...
            <div class="gallery_section_2">
                <div class="row">
                    <div class="col-md-4">
                        <div class="container_main">
                            <img src="{{ asset('assets/images/img-7.png') }}" alt="Avatar" class="image">
                            <div class="overlay">
                                <div class="text"><a href="#"><i class="fa fa-search"
                                            aria-hidden="true"></i></a></div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="container_main">
                            <img src="{{ asset('assets/images/img-8.png') }}" alt="Avatar" class="image">
                            <div class="overlay">
                                <div class="text"><a href="#"><i class="fa fa-search"
                                            aria-hidden="true"></i></a></div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="container_main">
                            <img src="{{ asset('assets/images/img-9.png') }}" alt="Avatar" class="image">
                            <div class="overlay">
                                <div class="text"><a href="#"><i class="fa fa-search"
                                            aria-hidden="true"></i></a></div>
                            </div>
